function [x_history, u_history, status, sqp_iter, time_tot, time_lin, ...
    time_qp_sol] = cl_run_fun(model, ocp, sim, map, p_swarm, dt, p, ...
    nb_steps_sim, x0, end_line)
...
%     ocp.print('stat');
    ...
    if sum(pos_swarm(1,:) > end_line) == p_swarm.nb_agents
        break;
    end
