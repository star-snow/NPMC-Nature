...
% distances and speeds in the small-scale environment.
...
% opt_params = [0.2000, 2.1300, 0.0500, 0.6300, 3.200, 0.10400, ... 
%     0.1000, 0.9600, 1.5500, 1.5100];
    ...
    for i = 1 : blocks_len
        for j = 1 : d_len
            for k = 1 : v_len
                ...
                resutls_path = strcat('results/vasarhelyi/robustness_1/', ...
                                num2str(j),'_d_ref/');
